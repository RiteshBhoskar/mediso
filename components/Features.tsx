    ...
    return (
        <div  className="w-full py-7 flex justify-center bg-slate-50">
          <div className="container px-4 md:px-4">
            ...
            <h2 className="text-[3.30rem] flex justify-center text-center pt-7 font-satoshi px-2 sm:px-60 pb-8 leading-tight text-[#363636] font-medium">Different types of features we have for your healthcare</h2>
