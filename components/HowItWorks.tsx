...
export default function HowItWorks() {
    return (
        <div className="w-screen flex justify-center bg-white pb-7 sm:py-10">
          <div className="container px-4 md:px-6 w-full flex flex-col lg:items-center sm:flex-row justify-between">
